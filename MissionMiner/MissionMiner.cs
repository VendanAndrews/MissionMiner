        ...
        public bool CheckForMissions(object[] Params)
        {
            ...
            else
            {
                if (CurrentAgent == null)
                {
                    if (!AgentQueue.Any())
                    {
                        if (Config.Level1) AgentQueue.AddRange(Agent.MyAgents.Where(a => a.AgentType == Agent.AgentTypes.BasicAgent && a.AgentDivision == Agent.AgentDivisions.Mining && a.Level == 1 && (!GlobalConfig.NextDecline.ContainsKey(Me.CharID) || !GlobalConfig.NextDecline[Me.CharID].ContainsKey(a.ID) || GlobalConfig.NextDecline[Me.CharID][a.ID] < DateTime.Now)));
                        if (Config.Level2) AgentQueue.AddRange(Agent.MyAgents.Where(a => a.AgentType == Agent.AgentTypes.BasicAgent && a.AgentDivision == Agent.AgentDivisions.Mining && a.Level == 2 && (!GlobalConfig.NextDecline.ContainsKey(Me.CharID) || !GlobalConfig.NextDecline[Me.CharID].ContainsKey(a.ID) || GlobalConfig.NextDecline[Me.CharID][a.ID] < DateTime.Now)));
                        if (Config.Level3) AgentQueue.AddRange(Agent.MyAgents.Where(a => a.AgentType == Agent.AgentTypes.BasicAgent && a.AgentDivision == Agent.AgentDivisions.Mining && a.Level == 3 && (!GlobalConfig.NextDecline.ContainsKey(Me.CharID) || !GlobalConfig.NextDecline[Me.CharID].ContainsKey(a.ID) || GlobalConfig.NextDecline[Me.CharID][a.ID] < DateTime.Now)));
                        if (Config.Level4) AgentQueue.AddRange(Agent.MyAgents.Where(a => a.AgentType == Agent.AgentTypes.BasicAgent && a.AgentDivision == Agent.AgentDivisions.Mining && a.Level == 4 && (!GlobalConfig.NextDecline.ContainsKey(Me.CharID) || !GlobalConfig.NextDecline[Me.CharID].ContainsKey(a.ID) || GlobalConfig.NextDecline[Me.CharID][a.ID] < DateTime.Now)));
                    }
